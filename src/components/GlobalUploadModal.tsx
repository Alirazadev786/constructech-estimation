          ...
          <div className="p-6 overflow-y-auto flex-grow space-y-6">
            {isSuccess ? (
              ...
              <div className="text-center py-8 px-4 animate-scale-up">
                ...
                <button
                  onClick={() => setIsOpen(false)}
                  className="bg-brand-orange hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-lg transition-colors shadow-md"
                >
                  Close Window
                </button>
              </div>
              ...
              <form onSubmit={handleUploadSubmit} className="space-y-6">
                ...
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                  <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-3 flex items-center justify-between">
                    ...
                    <button 
                      ...
                      className="text-brand-orange hover:underline normal-case font-bold"
                    >
                      + Add More
                    </button>
                  </h4>
                  <div className="space-y-2 max-h-[120px] overflow-y-auto pr-1">
                    {files.map((file, i) => (
                      <div key={i} className="flex justify-between items-center bg-white p-2.5 rounded-lg border border-gray-150 text-xs">
                        ...
                        <span className="text-gray-400 font-medium shrink-0">{file.size}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <button 
                  type="submit"
                  className="w-full bg-brand-orange hover:bg-orange-600 text-white font-bold py-3.5 px-6 rounded-lg shadow-md transition-colors transform hover:-translate-y-0.5"
                >
