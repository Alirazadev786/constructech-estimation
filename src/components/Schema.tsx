export default function Schema() {
  ...
  const websiteSchema = {
    ...
    "description": "Constructech Estimation provides professional Construction Estimating Services, experienced Construction Estimators, and accurate cost estimation solutions for contractors and builders across the United States.",
    "inLanguage": "en-US",
    "publisher": {
      "@id": "https://constructechestimation.com/#organization"
    }
  ...
  const serviceSchema = {
    ...
    "description": "Constructech Estimation provides professional Construction Estimating Services in the United States, offering accurate cost estimation, experienced construction estimators, material takeoffs, and bid support solutions for contractors and builders.",
